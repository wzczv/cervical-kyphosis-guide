...
const trafficSprintArticles = [
  ...
  topic("cervical-kyphosis-exercises-to-avoid", "exercises", [sources.neckPainGuideline, sources.returnSport, sources.radiculopathy], {
    ...
    en: ["Exercise boundaries", "Kyphosis Exercises to Avoid: What Not to Force", "Kyphosis exercises to avoid or modify include forced neck stretches, loaded flexion or extension, hard traction, nerve tension drills, and anything that creates a next-day flare.", "Avoid forcing movements that spread pain, worsen numbness, create weakness, trigger dizziness, or leave a worse next-day response.", ["Modify or avoid forced chin-to-chest, deep extension, and long end-range neck holds.", "Pause heavy overhead work, loaded neck flexion or extension, and hard traction when symptoms are irritable.", "Stop a drill that spreads numbness, weakness, dizziness, or next-day symptoms.", "Choose exercises by the 24-hour response."]],
